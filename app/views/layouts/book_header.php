...
<body>
    <header
        class="navbar z-50 bg-white  top-0 left-0 w-full px-4 md:px-8 border shadow-lg h-20 flex items-center justify-between">
        ...
        <div class="authbtn hidden md:flex items-center gap-4 text-lg text-blue-900">
            ...
            <?php } else { ?>
                <a href="/login" class="hover:text-black flex items-center gap-2">
                    <?php echo $user->name ?>
