    ...
    <div class="absolute inset-0 bg-black/20 backdrop-blur-md flex justify-center items-center">
        <form class="rounded-lg bg-gray-100 border p-6 sm:p-8 mx-2 sm:mx-10 flex flex-col gap-[6px] w-full max-w-lg md:max-w-2xl" method="post" enctype="multipart/form-data" action="/editbook">
            ...
            <div class="flex flex-col w-full mb-2">
                ...
                <textarea id="description" class="p-2 border bg-gray-200 rounded-lg outline-none focus:outline-gray-400" name="description" placeholder="Describe the condition of book" value="<?php echo $book['description']?>"></textarea>
            </div>
            ...
            <div class="flex flex-col w-full">
                ...
                <a href='book/viewbook' class="text-blue-700">View Books </a>
            </div>
        </form>
    </div>
</div>
